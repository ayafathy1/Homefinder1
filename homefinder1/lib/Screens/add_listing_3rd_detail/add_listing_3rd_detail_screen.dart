...
class AddListingThirdDetailsScreen extends StatefulWidget {
  ...
  State<AddListingThirdDetailsScreen> createState() =>
      _AddListingThirdDetailsScreenState();
}

class _AddListingThirdDetailsScreenState
    extends State<AddListingThirdDetailsScreen> {
  String groupValue = "yes";
  String groupValue1 = "yes";
  String groupValue2 = "yes";
  @override
  Widget build(BuildContext context) {
    return GetBuilder<AddListingThirdDetailsController>(
        init: AddListingThirdDetailsController(widget.residanceId),
        builder: (AddListingThirdDetailsController controller) {
          return Scaffold(
            appBar: AppBar(
