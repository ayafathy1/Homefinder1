...
import 'package:homefinder1/Screens/edit_listing_fourth_details/edit_listing_fourth_detail.dart';
...
class EditListingThirdDetailsController extends GetxController {
  ...
  EditListingThirdDetailsController(this.residanceId);
  ...
  Future <void> thirdedit(
      BuildContext context,
      )async{
    try{
      ThirdEditModel? data = await ResidenceServices.thirdEdit(
          hasGarageSelected,
          garageTypeSelected,
      ...
      if (data?.status == "success") {
        Get.to(() =>EditListingFourthDetailsScreen(residanceId: residanceId,));
      }
    } catch (e) {
