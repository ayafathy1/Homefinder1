...
class _SignUpState extends State<SignUp> {
  ...
  return GetBuilder(
      ...
      return   Scaffold(
        ...
        CustomTextFieldWidget(
            Controller: controller.emailaddressController, validator: controller.emailValidator, keyboardType: TextInputType.emailAddress, textfieldHint:"EmailAddress", textfieldIcon: Image(image: AssetImage("lib/assets/images/Message1.png"),), ispasswordField: false, obscureText: false),

        CustomTextFieldWidget(Controller: controller.passwordController, validator: controller.passwordValidator, keyboardType: TextInputType.visiblePassword, textfieldHint: "Password", textfieldIcon:Image(image: AssetImage("lib/assets/images/Lock1.png"),), ispasswordField: true, obscureText: true),
        CustomTextFieldWidget(Controller: controller.passwordController, validator:controller.passwordValidator, keyboardType: TextInputType.visiblePassword, textfieldHint: "Confirm Password", textfieldIcon:Image(image: AssetImage("lib/assets/images/Lock1.png"),), ispasswordField:true, obscureText: true),
        Row(children: [
