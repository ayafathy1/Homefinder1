...
class ResidenceServices {
  ...
  static Future<ResponseModel?> deleteResidenceImage(String imgId,BuildContext context) async {
    var data = await api.request(context: context,"residence/image/${imgId}", "DELETE",
        headers: {
          "Authorization":Get.find<StorageService>().getToken,
