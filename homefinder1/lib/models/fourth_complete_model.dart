...
FourthCompleteModel welcomeFromJson(String str) => FourthCompleteModel.fromJson(json.decode(str));

String welcomeToJson(FourthCompleteModel data) => json.encode(data.toJson());

class FourthCompleteModel {
  String? status;
  Residence? residence;
  ...
  factory FourthCompleteModel.fromJson(Map<String, dynamic> json) => FourthCompleteModel(
    status: json["status"],
